...
license_text = "The Bot is hosted by @GeloMyrtol. It's free software (like in freedom not in free beer) and is available under MIT Lizenz at https://github.com/TheVillageDev/makebot."
